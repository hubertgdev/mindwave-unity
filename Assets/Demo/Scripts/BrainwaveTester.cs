...
public class BrainwaveTester : MonoBehaviour
{
    ...
    private struct ESensePattern
    {
        ...
        public ESensePattern(float _Target, float _IncreaseDuration, float _ValueAfterIncreaseEnd)
        {
            target = _Target;
            increaseDuration = _IncreaseDuration;
            valueAfterIncreaseEnd = _ValueAfterIncreaseEnd;
        }
    }
    ...
    private ESensePattern m_MeditationPattern = new ESensePattern();
    ...
    private ESensePattern m_AttentionPattern = new ESensePattern();
